...
public:
    ...
    struct Buffer {
        ...
        GLint attribID;  ///< The associated attribute handle
...
public:
    ...
    void inittexture(const Vector2i &size);
    ...
    void bindtexture(const Vector2i &size, const int idx,const bool resizex=true);
...
protected:
    GLuint mFramebuffer, mDepth, mColor, texturebuffer;
    Vector2i mSize;
    int mSamples;
public:
